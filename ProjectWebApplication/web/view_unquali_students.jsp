...
<html>
    ...
    <body>
        <div class="brody">
        <h4>The list is based on all successfully submitted applications whose applicants do not qualify to study for the chosen qualification.</h4>
        <a href="ViewNonQulifyingApplicantsServlet.do">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
