...
<html>
    ...
    <body>
        <div class="brody">
        <h4>The list is based on all successfully submitted applications whose applicants qualify to study for the chosen qualification.</h4>
        <a href="ViewQulifyingApplicantsServlet.do">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
